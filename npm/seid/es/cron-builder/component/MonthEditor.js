...
var defaultRadioKeyValue = (_defaultRadioKeyValue = {}, _defineProperty(_defaultRadioKeyValue, index.EVERY, '*'), _defineProperty(_defaultRadioKeyValue, index.BETWEEN, '1-2'), _defineProperty(_defaultRadioKeyValue, index.FROM_EVERY, '1/1'), _defineProperty(_defaultRadioKeyValue, index.CHECK_BOX, 'C'), _defaultRadioKeyValue);

var MonthEditor =
/*#__PURE__*/
function (_BaseEditor) {
  _inherits(MonthEditor, _BaseEditor);

  function MonthEditor(props) {
    var _this;

    _classCallCheck(this, MonthEditor);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(MonthEditor).call(this, props));
    _this.state = {
  ...
  _createClass(MonthEditor, [{
    ...
    value: function render() {
      ...
      return React.createElement(RadioGroup, {
        ...
        style: radioStyle,
        value: index.EVERY
      }, locale.everyMouth), React.createElement(Radio, {
        style: radioStyle,
        value: index.BETWEEN
...
//# sourceMappingURL=MonthEditor.js.map
