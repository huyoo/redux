...
function (_PureComponent) {
  _inherits(ListLoader, _PureComponent);

  function ListLoader() {
    _classCallCheck(this, ListLoader);

    return _possibleConstructorReturn(this, _getPrototypeOf(ListLoader).apply(this, arguments));
  }
  ...
  _createClass(ListLoader, [{
    ...
    value: function render() {
      ...
      return React.createElement("div", {
        style: style,
        className: cls('seid-list-loader', 'spinning', className, {
          'hidden': !spinning
        })
